  ...
  return (
    <section className="relative min-h-screen overflow-hidden pb-14 pt-28 md:pt-32">
      <div className="absolute inset-0">
        <div className="absolute left-[8%] top-[18%] size-2 rounded-full bg-accent/70 shadow-glow" />
        <div className="absolute left-[76%] top-[24%] size-1.5 rounded-full bg-primary/70 shadow-glow" />
      ...
      <div className="section-shell relative grid min-h-[calc(100vh-112px)] items-center gap-12 lg:grid-cols-[1fr_0.92fr]">
        ...
        >
          <div className="glass-surface mb-6 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-foreground">
          ...
          <div className="mt-11 grid gap-3 sm:grid-cols-3">
            {stats.map((stat) => (
              <div className="glass-surface rounded-lg px-5 py-4" key={stat.label}>
        ...
        <motion.div style={{ y: imageY }} className="relative hidden lg:block">
          <div className="glass-surface relative aspect-[4/5] overflow-hidden rounded-lg shadow-glass">
            <Image
            ...
            <div className="glass-surface absolute bottom-6 left-6 right-6 rounded-[24px] p-5">
              <p className="text-sm text-muted">Liquid Glass Studio</p>
